                    ...
                    <div class="login__form" style="color:white;">
                        ...
                        <form action="{{ url('serie/' . $serie->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input__item  " >
                                ...
                                <input id="peli" name="titulo" class=" @error('titulo') is-invalid @enderror input-color " value="{{ old('titulo',$serie->titulo)}}" type="text" placeholder="Titulo Pelicula:">
                            ...
                            <div class="input__item ">
                                ...
                                <input id="studio" name="studio" class=" @error('studio') is-invalid @enderror input-color " value="{{ old('studio',$serie->studio )}}" type="text" placeholder="Estudio Pelicula:">
                            ...
                            <div class="input__item ">
                                ...
                                <input type="number" class=" @error('puntaje') is-invalid @enderror input-color " value="{{ old('puntaje',$serie->puntaje)}}" step="0.5" min="0.5" max="5" name="puntaje" id="puntaje" placeholder="Puntaje: ">
                            ...
                            <div class="input__item ">
                                <input type="number" step="any" min="15" max="420" class=" @error('duracion') is-invalid @enderror input-color " value="{{ old('duracion',$serie->duracion)}}" name="duracion" id="duracion" placeholder="Duracion: ">
                            ...
                            <div class="input__item ">
                                <input type="number" min='1' class=" @error('temporadas') is-invalid @enderror input-color" name="temporadas" id="temporadas" value="{{ old('temporadas',$serie->temporadas) }}" placeholder="Temporadas: ">
                      ...
                      <div class="col-lg-5" style="color:white;">
                              ...
                              <div class="input__item">
                                ...
                                <select id="premium" class="form-control input-color @error('espremium') is-invalid @enderror" name="espremium" type="text" placeholder="Elige tipo de pelicula:">
                                        ...
                                        @foreach($espremium as $premium)
                                            <option value="{{ $premium }}" @if(old('espremium', $serie->espremium ) == $premium)  selected @endif >{{ $premium }}</option>    
                               ...
                               <select id="categoria" class="form-control input-color @error('categoria') is-invalid @enderror" name="categoria" type="text" placeholder="">
                                     <option value=""  @if(old('categoria') == '') selected  @endif disabled >&nbsp;</option>
                                        @foreach($categorias as $categoria)
                                            <option value="{{ $categoria }}" @if(old('categoria',$serie->categoria) == $categoria)  selected @endif >{{ $categoria }}</option>    
                              ...
                              <div class="input__item">
                                   ...
                                   <select id="categoria2" class="form-control input-color @error('categoria2') is-invalid @enderror" name="categoria2" type="text" placeholder="">
                                         <option value=""  @if(old('categoria2') == '') selected  @endif disabled >&nbsp;</option>
                                            @foreach($categorias as $categoria)
                                                <option value="{{ $categoria }}" @if(old('categoria2',$serie->categoria2) == $categoria)  selected @endif >{{ $categoria }}</option>    
                              ...
                              <div class="input__item">
                                   ...
                                   <select id="edad" class="form-control input-color @error('edad') is-invalid @enderror" name="edad" type="text" placeholder="">
                                         <option value=""  @if(old('edad') == '') selected  @endif disabled >&nbsp;</option>
                                            @foreach($edades as $edad)
                                                <option value="{{ $edad }}" @if(old('edad',$serie->edad) == $edad)  selected @endif >{{ $edad }}</option>    
                                ...
                                <div class="input__item">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-color"  name="descripcion" id="exampleFormControlTextarea1" rows="3">{{ old('descripcion',$serie->descripcion)}}</textarea>
                                    </div>
                         ...
                         <button type="submit" style="margin-left:20%; margin-top:80px" class="site-btn">Editar Serie</button>
